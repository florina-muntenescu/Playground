 ...
 */
public class TapToSlideTranslateAnimationView extends TapToSlideView {

    public TapToSlideTranslateAnimationView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }
